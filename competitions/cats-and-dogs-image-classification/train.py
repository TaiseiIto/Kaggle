...
if __name__=='__main__':
	...
	train_image_path_id2train_image = {train_image_path2train_image_path_id[train_image_path] : numpy.array(Image.open(train_image_path).convert('RGB').resize(image_size)) / 0xff for train_image_path in train_image_paths}
	...
	test_image_path_id2test_image = {test_image_path2test_image_path_id[test_image_path] : numpy.array(Image.open(test_image_path).convert('RGB').resize(image_size)) / 0xff for test_image_path in test_image_paths}
